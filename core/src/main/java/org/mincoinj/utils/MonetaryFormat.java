...
public final class MonetaryFormat {
    ...
    public static final String CODE_BTC = "MNC";
    /** Currency code for base 1/1000 Bitcoin. */
    public static final String CODE_MBTC = "mMNC";
    /** Currency code for base 1/1000000 Bitcoin. */
    public static final String CODE_UBTC = "µMNC";

    /* cryptodadJun 2019 - no unicode char for mincoin - should be able to remove this*/
    ...
    /* cryptodad Jun 2019 - no unicode char for mincoin */
