...
import org.mincoinj.utils.ListenerRegistration;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.mincoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.mincoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
