...
import org.mincoinj.core.BloomFilter;
...
import org.mincoinj.core.Message;
import org.mincoinj.core.NetworkParameters;
import org.mincoinj.core.Peer;
import org.mincoinj.core.PeerFilterProvider;
...
import org.mincoinj.core.TransactionBag;
import org.mincoinj.core.TransactionBroadcast;
import org.mincoinj.core.TransactionBroadcaster;
...
import org.mincoinj.core.UTXOProvider;
import org.mincoinj.core.UTXOProviderException;
...
import org.mincoinj.signers.*;
import org.mincoinj.utils.*;
import org.mincoinj.wallet.Protos.Wallet.*;
...
public class Wallet extends BaseTaggableObject
     ...
     * key, after loading a wallet produced by previous versions of mincoinj. If the wallet is encrypted the key
     ...
     * @throws org.mincoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.mincoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.mincoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
