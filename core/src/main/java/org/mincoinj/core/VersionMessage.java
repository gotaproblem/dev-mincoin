...
public class VersionMessage extends Message {
    ...
    public static final String LIBRARY_SUBVER = "/mincoinj:" + BITCOINJ_VERSION + "/";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for mincoinj
     * users might look like "/mincoinj:0.13/MultiBit:1.2/" where libraries come further to the left.</p>
     *
     ...
     * set of "/mincoinj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
