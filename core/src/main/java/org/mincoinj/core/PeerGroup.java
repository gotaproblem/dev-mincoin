...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of mincoinj fixes the known
        ...
        try {
            if (minBroadcastConnections == 0) {
                ...
                if (max <= 1)
                    ...
                    return (int) Math.round(getMaxConnections() * 0.5); /* cryptodad Jul 2019 - changed for testnet */
            }
     ...
     * and easy way for a user to upgrade a mincoinj based app running in SPV mode to fully validating security.
     */
