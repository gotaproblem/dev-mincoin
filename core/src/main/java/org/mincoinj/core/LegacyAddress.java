...
import org.mincoinj.params.Networks;
...
public class LegacyAddress extends Address {
    ...
    public static LegacyAddress fromBase58(@Nullable NetworkParameters params, String base58)
        ...
        if (params == null) {
            ...
            /* cryptodad Jul 2019 - there is a problem here if using testnet4, as mainnet instance
               is created but as block 0 differs between the two networks, the genesis hash fails,
               causing a crash!

               it would be best to call this function with params defined
            */
            //NetworkParameters p = TestNet4Params.get();
