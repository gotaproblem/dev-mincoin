...
import org.mincoinj.net.AbstractTimeoutHandler;
import org.mincoinj.net.NioClient;
import org.mincoinj.net.NioClientManager;
import org.mincoinj.net.StreamConnection;
...
public class Peer extends PeerSocketHandler {
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        log.info(toString());
        // mincoinj is a client mode implementation. That means there's not much point in us talking to other client
