...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    /* cryptodad May 2019 */
    public static final Coin FIVE_HUNDRED_COINS = COIN.multiply(500);
    public static final Coin ONE_HUNDRED_COINS = COIN.multiply(100);
    public static final Coin TWO_COINS = COIN.multiply(2);
