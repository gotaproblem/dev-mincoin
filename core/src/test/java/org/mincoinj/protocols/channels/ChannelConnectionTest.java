...
package org.mincoinj.protocols.channels;

import org.mincoinj.core.*;
import org.mincoinj.protocols.channels.PaymentChannelClient.VersionSelector;
import org.mincoinj.script.ScriptPattern;
import org.mincoinj.testing.TestWithWallet;
...
import static org.mincoinj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.mincoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.mincoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
