...
import org.mincoinj.wallet.WalletTransaction.Pool;
...
import org.mincoinj.wallet.Protos.Wallet.EncryptionType;
...
import static org.mincoinj.core.Utils.HEX;
import static org.mincoinj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: mincoinj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("mincoinj-unit-test", null);
    ...
    public void recipientPaysFees() throws Exception {
        ...
        valueToSend = COIN.divide(2).subtract(Coin.COIN); // might need to change divide
        ...
        /* cryptodad Jun 2019 - no milli, micro etc */
        ...
        Coin valueToSend1 = fee6.divide(2).add(Transaction.MIN_NONDUST_OUTPUT).add(Coin.COIN);
        Coin valueToSend2 = COIN.subtract(valueToSend1).subtract(Coin.COIN.multiply(2)); // might need to change/remove multiply
    ...
    public void childPaysForParent() throws Exception {
        ...
        final Coin feeRaise = COIN; // likely need to change this
